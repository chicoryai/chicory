"""
Configuration management for Analytics MCP Server.
"""
...
class Config:
    """Configuration settings for the Analytics MCP Server."""
    ...
    def validate(self) -> bool:
        ...
        if self.DEFAULT_PAGE_SIZE <= 0 or self.DEFAULT_PAGE_SIZE > self.MAX_PAGE_SIZE:
            raise ValueError("DEFAULT_PAGE_SIZE must be positive and <= MAX_PAGE_SIZE")
