...
- Action:
  1. Triggers on PR creation - Automatically runs when a new pull request is opened
  2. Extracts PR details - Collects PR information (title, author, description, changed files, and code diff)
  3. Calls Chicory AI agent - Sends all the PR data to a specific Chicory agent via API for analysis
